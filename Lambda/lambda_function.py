    ...
    if age is not None:
        ...
        if age > 65 or age<=0:
            return build_validation_result(
                False,
                "age",
                "You should be at least 0 years old and less than 65 years old to use this service, "
    ...
    if investmentAmount is not None:
        ...
        if investmentAmount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The amount to convert should be greater or equal to 5000, "
    ...
    if risk_level is not None:
        ...
        if risk_level=='Low':
            return build_validation_result(
                    False,
                    "riskLevel",
                    "Your portfolio should be 60% bonds (AGG), 40% equities (SPY)"
                )
        ...
        if risk_level=='Medium':
            return build_validation_result(
                    False,
                    "riskLevel",
                    "Your portfolio should be 40% bonds (AGG), 60% equities (SPY)"
                )
        ...
        if risk_level=='High':
            return build_validation_result(
                    False,
                    "riskLevel",
                    "Your portfolio should be 20% bonds (AGG), 80% equities (SPY)"
                )
